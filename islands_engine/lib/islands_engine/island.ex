defmodule IslandsEngine.Island do
  ...
  defp offset(:atoll), do: [{0, 0}, {0, 1}, {0, 2}, {2, 0}, {2, 1}]
  defp offset(:dot), do: [{0, 0}]
  defp offset(:l_shape), do: [{0, 0}, {0, 1}, {0, 2}, {1, 2}]
  ...
  defp add_coordinates(offset, upper_left) do
    Enum.reduce_while(offset, MapSet.new(), fn offset, acc ->
